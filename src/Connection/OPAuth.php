...
namespace DevEcommercePL\OrlenPaczka\Connection;
...
class OPAuth {
    ...
    public function __construct($attributes = []) {
        // Init params:
        $this->PartnerID = isset($attributes['PartnerID']) ? $attributes['PartnerID'] : null;
        $this->PartnerKey = isset($attributes['PartnerKey']) ? $attributes['PartnerKey'] : null;
